...
$MiniCover reset
dotnet test --no-build test/MiniCover.XUnit.Tests/MiniCover.XUnit.Tests.csproj || true
dotnet test --no-build test/MiniCover.NUnit.Tests/MiniCover.NUnit.Tests.csproj || true
